                ...
                <div class="col-md-offset-2">
                    <div class="col-md-10">
                        <div class="form-group {{ $errors->has('reg_email')?'has-error':'' }}">
                            <label class="control-label" for="Реєєстраційна пошта">Ел. пошта для реєстрації:<span class="form-required">*</span></label>
                            <input type="email" value="{{ old('reg_email') }}" name="reg_email" class="form-control"
                                   id="text">
                            @if($errors->has('reg_email'))
                                <span class="control-label"> {{ $errors->first('reg_email') }}</span>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('name')?'has-error':'' }}">
                        <label class="control-label" for="name">Назва проекту:<span class="form-required">*</span></label>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('money')?'has-error':'' }}">
                        <label class="control-label" for="money">Вартість проекту ($)<span
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('contacts')?'has-error':'' }}">
                        <label class="control-label" for="Contacts">Контактні дані: <span class="form-required">*</span></label>
                        <textarea rows="4" type="text" name="contacts" class="form-control"
                                  id="text">{{ old('contacts') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('idea')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="idea" class="form-control"
                                  id="text">{{ old('idea') }}</textarea>
                        @if($errors->has('idea'))
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('current_situation')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="current_situation" class="form-control"
                                  id="text">{{ old('current_situation') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('problem')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="problem" class="form-control"
                                  id="text">{{ old('problem') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('solution')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="solution" class="form-control"
                                  id="text">{{ old('solution') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('competition')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="competition" class="form-control"
                                  id="text">{{ old('competition') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('benefits')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="benefits" class="form-control"
                                  id="text">{{ old('benefits') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('buisness_model')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="buisness_model" class="form-control"
                                  id="text">{{ old('buisness_model') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('money_target')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="money_target" class="form-control"
                                  id="text">{{ old('money_target') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('investor_interest')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="investor_interest" class="form-control"
                                  id="text">{{ old('investor_interest') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('risks')?'has-error':'' }}">
                        ...
                        <textarea rows="4" type="text" name="risks" class="form-control"
                                  id="text">{{ old('risks') }}</textarea>
                        @if($errors->has('risks'))
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group {{ $errors->has('other')?'has-error':'' }}">
                        ...
                        <textarea type="text" name="other" class="form-control" id="text"
                                  rows="6">{{ old('other') }}</textarea>
            ...
            <div class="col-md-offset-2">
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <input type="file" name="project_files[]" class="form-control" multiple id="documents">
                    </div>
                </div>
            </div>
            <div class="col-md-offset-2">
