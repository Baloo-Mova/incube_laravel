                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                @foreach($executorProjects as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('admin.executor.show', [$item->id])}}" title="View" aria-label="View" data-pjax="0">
                                                <span class="glyphicon glyphicon-eye-open"></span>
                                            </a>
                                            
                                                <a href="{{route('admin.executor.edit', [$item->id])}}" title="Update" aria-label="Update" data-pjax="0">
                                                    <span class="glyphicon glyphicon-pencil"></span></a>

                                                <a href="{{route('admin.executor.delete', ['id'=>$item->id]) }}" title="Delete" aria-label="Delete" data-confirm="Ви Дійсно хочете видалити заявку?" data-method="post" data-pjax="0">
