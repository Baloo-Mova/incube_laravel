            ...
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('author_id')?'has-error':'' }}">
                    ...
                    <select id="country_id" class="form-control" name="author_id">
                        ...
                        <option value="{{ $user->id }}" {{ ( $problem->author_id == $user->id ? "selected":"") }}>{{ $user->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('publisher_id')?'has-error':'' }}">
                    ...
                    <select id="country_id" class="form-control" name="publisher_id">
                        @foreach(\App\User::all() as $user)
                        <option value="{{ $user->id }}" {{ ( $problem->publisher_id == $user->id ? "selected":"") }}>{{ $user->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('status_id')?'has-error':'' }}">
                    ...
                    <select id="country_id" class="form-control" name="status_id">
                        ...
                        <option value="{{ $status->id }}" {{ $problem->status_id == $status->id ? "selected" : "" }}>{{ $status->name }}</option>
                        @endforeach
                    </select>
