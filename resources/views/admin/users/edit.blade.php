...
<div class="page-title text-center">
    <h2>Оновлення заявки питання(проблеми). Ідентифікаційний номер:{{$user->id}}</h2>
</div>
<hr/>
<div class="container">
    ...
    <div class="col-md-offset-2">
        <div class="c col-md-10 text-center">
            ...
            <a href="{{ route('admin.users.show',['user'=>$user->id]) }}" class="btn-primary btn">Продивитись</a>
        </div>
    </div>
    @endif
        ...
        <div class="col-md-offset-2">
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('name')?'has-error':'' }}">
                    ...
                    <input type="text" value="{{ $user->name }}" name="name" class="form-control" id="text">
                    @if($errors->has('name'))
        ...
        <div class="col-md-offset-2">
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('password')?'has-error':'' }}">
                    ...
                    <input type="text" value="{{ $user->password }}" name="password" class="form-control" id="text">
        ...
        <div class="col-md-offset-2">
            <div class="col-md-10">
                <div class="form-group">
                    ...
                    <input type="email" value="{{ $user->email }}" name="email" class="form-control" id="text">
        ...
        <div class="col-md-offset-2">
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('adress')?'has-error':'' }}">
                    ...
                    <textarea rows="3" type="text" name="adress" class="form-control" id="text">{{ $user->adress }}</textarea>
        ...
        <div class="col-md-offset-2">
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('phone_number')?'has-error':'' }}">
                    ...
                    <input type="text" value="{{ $user->phone_number }}" name="phone_number" class="form-control" id="text">
        ...
        <div class="col-md-offset-2">
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('web_site')?'has-error':'' }}">
                    ...
                    <input type="text" value="{{ $user->web_site }}" name="web_site" class="form-control" id="text">
        ...
        <div class="col-md-offset-2">
            <div class="col-md-10">
                <div class="form-group {{ $errors->has('contacts')?'has-error':'' }}">
                    ...
                    <textarea rows="3" type="text" name="contacts" class="form-control" id="text">{{ $user->contacts }}</textarea>
...
<script type="text/javascript">
    $("#logo").fileinput({
            ...
            'multiple': false,
            initialPreview: [
                "{{route('images.show',['id'=>$user->logo,'width'=>'max','height'=>'max'])}}"
            ],
        ...
        $("#bg_logo").fileinput({
            ...
            'multiple': false,
            initialPreview: [
                "{{route('images.show',['id'=>$user->bg_logo,'width'=>'max','height'=>'max'])}}"
            ],
            initialPreviewAsData: true,
            layoutTemplates: {
                actions: '<div class="file-actions">\n' +
