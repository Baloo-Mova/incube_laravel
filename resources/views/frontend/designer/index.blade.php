...
@section('content')
    ...
    <div class="container">
        ...
        <p>
            <b> Проектант </b> - це користувач, який пропонує свої проекти, з метою 
            співпраці наукової спільноти України з підприємствами великого, середнього
            та малого бізнесу. Ви можете на взаємовигідних умовах запропонувати їм свої вже
        ...
        <p><b>Проектантами</b> можуть виступати юридичні та фізичні особи, які можуть запропонувати проект.
        </p>
