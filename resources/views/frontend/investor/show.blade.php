        ...
        <div class="container">
            <div class="btn-toolbar">
                ...
                <div class="btn-group pull-right">
                    <a href="#" id="offer-project" data-toggle="modal" data-target="#myModal" class="btn btn-primary"> <span><i class="fa fa-check"></i> Запропонувати проект</span>
                    </a>
                </div>
                @endif
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table>
                    ...
                    @empty
                    <tr>
                        <td colspan="2"> У вас не має поданих проектів. Для подачі нового проекту скористайтеся кнопкою "Подати проект".</td>
                    </tr>
                    @endforelse
                </table>
            </div>
