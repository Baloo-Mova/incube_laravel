...
@section('content')
    ...
    <div class="container">
        ...
        <div class="text-center">
            <b>Інвесторомами</b> можуть виступати юридичні та фізичні особи, які можуть вкладати кошти у проект.
        ...
        <hr/>
        <div class="page-title text-center">
            <h2>Ви можете вкласти кошти у такі пропозиції</h2>
        </div>
        ...
        <div class="tab-content">
            ...
            <div class="row text-center all-questions">
                <a class="btn btn-success btn-lg margin-auto" href="{{ route('project_viewer.index', ['cat_id=1#Designer']) }}">
                    Усі проекти
                </a>
            </div>
        </div>
