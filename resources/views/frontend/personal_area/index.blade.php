    ...
    <div class="row well">
        <div class="col-md-2">
            <ul class="nav nav-pills nav-stacked well">
                ...
                <li><a href="{{url("/personal-area/edit/") . $thisUser->id }}"><i class="fa fa-user"></i> Профіль</a></li>
        ...
        <div class="col-md-10">
            <div class="pannel-row">
                <div class="panel background-logo" style="background-image: url('{{ empty($user->bg_logo)? '../img/bg_image.jpg' : url('/users/image/'.$user->bg_logo)}}')">
                    ...
                    <div class="name"><small>{{$thisUser->name}}, {{$thisUser->country_id}}</small></div>
            ...
            <ul class="nav nav-tabs" id="myTab">
                <li class='active'><a href="#customerProj" data-toggle="tab"><i class="fa fa-caret-down"f></i> Питання(проблеми)</a></li>
                <li><a href="#investorProj" data-toggle="tab"><i class="fa fa-caret-down"></i> Заявки на інвестування</a></li>
                ...
                <li><a href="#employerProj" data-toggle="tab"><i class="fa fa-caret-down"></i> Списки вакансій</a></li>
