                ...
                <table class="table table-striped table-bordered">
                    ...
                    @foreach($usersCustomerProjects as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('project_viewer.show',['material'=>$item->id])}}" title="View" aria-label="View"
                                   data-pjax="0">
                                    <span class="glyphicon glyphicon-eye-open"></span>
                                </a>
                                <a href="{{url('/problem/edit/'. $item->id)}}" title="Update" aria-label="Update"
                                   data-pjax="0">
                                    <span class="glyphicon glyphicon-pencil"></span></a>
                                <a href="{{url('/problem/delete/'. $item->id)}}" title="Delete" aria-label="Delete"
