...
@section('content')
    ...
    <div class="content-area">
        <div class="container">
                        ...
                        <div class="board">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="home">
                                    ...
                                    <p class="text-center">
                                        <a href="#" class="btn btn-success btn-outline-rounded green"> Детальніше
                                ...
                                <div class="tab-pane fade" id="profile">
                                    ...
                                    <p class="text-center">
                                        <a href="#" class="btn btn-success btn-outline-rounded green"> Створити свій аккаунт
                                            <span style="margin-left:10px;" class="glyphicon glyphicon-send"></span></a>
                                    </p>
                                </div>
            ...
            <div class="page-title text-center wow bounceInDown">
                        ...
                        <div class="row">
                            ...
                            <a class="homeTile ng-isolate-scope" href="#" ga-event-on="click" ga-event-category="Homepage" ga-event-action="Explore" ga-event-label="Technology">
                                <div class="homeTile-content" style="background-image: url('../img/eco_category/e<?= $i ?>.png')">
                                    ...
                                    <div class="homeTile-icon">
                                        <svg class="">
                                            <use xmlns:xlink="" xlink:href="#icon-icon-technology"></use>
                                        </svg>
                                    </div>
