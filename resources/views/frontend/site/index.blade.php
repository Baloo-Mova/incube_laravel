    ...
    <div class="container">
                ...
                <div class="how-it-work text-center owl-carousel owl-theme" id="how-it-work">
                    <a href="{{url('/problem')}}">
                        <div class="single-work wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <h3>Замовник</h3>
                            <p>Формує проблему (або завдання), яку необхідно вирішити </p>
                        </div>
                    </a>
                    <a href="{{url('/investor')}}">
                        <div class="single-work  wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <h3>Інвестор</h3>
                            <p>Юридичні та фізичні особи, які можуть вкладати кошти у проект</p>
                        </div>
                    </a>
                    <a href="{{url('/designer')}}">
                    ...
                    <a href="{{url('/executor')}}">
                        <div class="single-work wow fadeInUp" data-wow-delay="1.2s">
                            ...
                            <h3>Виконавець</h3>
                            <p>Фахівець у певній галузі, який може взяти участь у проекті або знайти роботу</p>
                        </div>
                    </a>
                    {{--<a href="{{url('/employer')}}">--}}
        ...
        <div class="materials">
            <div class="page-title text-center wow bounceInUp" data-wow-duration="1s">
                <h2><span>{{count($allMaterials)}}</span> нових пропозицій</h2>
            </div>
